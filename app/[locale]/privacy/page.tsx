        ...
        <div className="bg-gradient-to-br from-[#2E3139] to-[#1E2536] border-[2px] border-[#5B698B] rounded-2xl p-8 md:p-12">
          ...
          <div className="space-y-6 text-gray-300 font-light leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              {(t.raw('section1Items') as string[]).map((item, index) => (
            ...
            <p>
              <strong className="text-white">Important:</strong> {t('section2Content')}
            </p>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              {(t.raw('section7Items') as string[]).map((item, index) => (
                <li key={index}>{item}</li>
              ))}
            </ul>
