    ...
    <div id="pricing" className="flex flex-col bg-gradient-to-b from-[#0C0F15] to-[#040508] justify-center items-center w-full relative py-32 bp3:py-20">
      ...
      >
        <p className="text-gray-400 text-sm mb-2">
          Rejoignez plus de <span className="text-[#8096D2] font-semibold">10 000+ utilisateurs</span> satisfaits
        </p>
        <div className="flex items-center justify-center gap-1">
          ...
          <span className="ml-2 text-gray-400 text-sm">4.9/5 basé sur 2,847 avis</span>
        </div>
      </motion.div>
