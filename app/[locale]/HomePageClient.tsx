  ...
  useEffect(() => {
    const loadModels = async () => {
      try {
        ...
        setError(t('errors.loadingModels'))
      }
    }
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      if (!analyzeResponse.ok) {
        let errorMessage = t('errors.analysisError')
        try {
    ...
    <div className="relative min-h-screen w-full h-full flex flex-col items-center overflow-hidden">
          ...
          <div className="relative z-10 w-full space-y-8">
            ...
            {selectedFile && (
              ...
              >
                ...
                >
                  {isLoading ? `🔍 ${t('upload.analyzing')}` : `✨ ${t('upload.analyzeButton')}`}
                </button>
                {!modelsLoaded && (
                  <p className="text-sm text-gray-400 font-light">
                    {t('upload.loadingModels')}
                  </p>
                )}
              </motion.div>
            )}
      ...
      <div className="min-h-screen w-full h-full flex flex-col z-0 items-center relative bg-gradient-to-b from-[#0C0F15] to-[#0C0F16]">
        ...
        <div className="flex flex-col justify-center mt-14 items-center w-full relative z-10">
          <p className="text-[16px] text-gray-200">{t('usedBy')}</p>
          <GlowingAdSenseCard />
        </div>
        ...
        <div className="flex bp6:-mt-48 -mt-24 flex-col bg-transparent bg-gradient-to-b to-[#040508] from-[#0C0F15] justify-center items-center w-full relative">
          ...
          <div className="grid grid-cols-3 bp1:grid-cols-2 bp6:grid-cols-1 mt-14 gap-0 mb-10">
            <Grid
              ...
              text={t('features.smartAnalysisDesc')}
            >
              <Scan className="w-20 h-20" />
            </Grid>
            <Grid
              title={t('features.deepLearning')}
              text={t('features.deepLearningDesc')}
            >
              <TrendingUp className="w-20 h-20" />
            </Grid>
            <Grid
              title={t('features.aiRating')}
              text={t('features.aiRatingDesc')}
            >
              <Brain className="w-20 h-20" />
            </Grid>
            <Grid
              title={t('features.totalPrivacy')}
              text={t('features.totalPrivacyDesc')}
            >
              <Lock className="w-20 h-20" />
            </Grid>
            <Grid
              title={t('features.instantResults')}
              text={t('features.instantResultsDesc')}
            >
              <Zap className="w-20 h-20" />
            </Grid>
            <Grid
              title={t('features.artificialIntelligence')}
              text={t('features.artificialIntelligenceDesc')}
            >
        ...
        <div className="flex pt-32 flex-col bg-gradient-to-b from-[#040508] to-[#0C0F15] bg-transparent justify-center items-center w-full relative">
          ...
          <div className="grid grid-cols-3 bp1:grid-cols-2 bp6:grid-cols-1 mt-14 gap-4 mb-10">
            <Grid2
              ...
              name={t('testimonials.testimonial1Author')}
            />
            <Grid2
              text={t('testimonials.testimonial2')}
              name={t('testimonials.testimonial2Author')}
            />
            <Grid2
              text={t('testimonials.testimonial3')}
              name={t('testimonials.testimonial3Author')}
            />
            <Grid2
              text={t('testimonials.testimonial4')}
              name={t('testimonials.testimonial4Author')}
            />
            <Grid2
              text={t('testimonials.testimonial5')}
              name={t('testimonials.testimonial5Author')}
            />
            <Grid2
              text={t('testimonials.testimonial6')}
              name={t('testimonials.testimonial6Author')}
            />
          </div>
        </div>
        ...
        <div className="flex w-full mt-32 flex-col bg-gradient-to-b to-[#040508] from-[#0C0F15] bg-transparent justify-center items-center relative">
          ...
          <div className="w-[90%] max-w-6xl mt-10 mb-10 gap-20 flex bp7:flex-col flex-row items-center justify-evenly">
            <div className="flex flex-col relative ">
              ...
              <p className="text-4xl font-light">{t('contact.heading1')}</p>
            ...
            <div className="flex bp7:hidden gap-4 flex-col">
              <div className="flex flex-col">
                <p className="font-light text-sm">{t('contact.name')}</p>
                <input
              ...
              <div className="flex flex-col">
                <p className="font-light text-sm">{t('contact.email')}</p>
                <input
                  className="w-[500px] bp7:w-[350px] text-sm pl-3 bg-transparent border-[1px] mt-2 h-[35px] text-white border-[#333B4F] rounded-md focus:outline-none focus:border-[#8096D2]"
                  style={{ zIndex: 50, position: "relative" }}
                />
              ...
              <div className="flex flex-col">
                <p className="font-light text-sm">{t('contact.message')}</p>
                <input
        ...
        <div className="w-full flex justify-center text-gray-400 text-sm font-light mb-3 items-center">
          <p>{t('common.allRightsReserved')} &copy; 2025 face10ai.com</p>
        </div>
      </div>
    </div>
  )
